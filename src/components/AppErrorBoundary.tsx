...
> {
  ...
  render() {
    ...
    return (
      <div className="min-h-screen bg-background text-[#EFEFEF] flex items-center justify-center p-6">
        <div className="glass-card w-full max-w-md p-6 text-center">
          <p className="text-5xl font-black text-primary">Error</p>
          <h1 className="mt-4 font-bebas text-2xl font-bold">
            Algo salió mal
          </h1>
          ...
          <div className="mt-6 flex flex-col gap-3">
            ...
            <a
              href="/"
              className="h-11 inline-flex items-center justify-center rounded-md border border-[#5E5E5E] bg-[#111111] px-4 text-sm font-semibold hover:bg-[#111111]/70"
            >
              Volver al inicio
            </a>
          </div>
          ...
          {import.meta.env.DEV && (
            <pre className="mt-6 max-h-48 overflow-auto rounded-md bg-[#111111]/50 p-3 text-left text-xs text-zinc-400">
