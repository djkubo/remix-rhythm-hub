...
export const translations: Translations = {
  ...
  "pricing.monthly": { es: "PLAN PRO DJ MENSUAL", en: "MONTHLY PRO" },
  "pricing.annual": { es: "PLAN 2 TB / MES – 195 ANUAL", en: "ANNUAL ELITE" },
  ...
  "pricing.feat1": { es: "1000 GB cada mes", en: "1000 GB each month" },
  "pricing.feat2": { es: "Acceso FTP completo", en: "Full FTP Access" },
  "pricing.feat3": { es: "Updates Semanales", en: "Weekly Updates" },
  "pricing.feat4": { es: "2000 GB cada mes", en: "2000 GB each month" },
  ...
  "faq1.answer": {
    es: "Pack individual desde $35 USD, membresía desde $35USD/m y $195USD/a, y USB física desde $147 USD.",
    en: "Single packs start at $35 USD, membership starts at $35/month and $195/year, and physical USB starts at $147 USD.",
  },
  "faq2.question": {
    es: "¿Cómo funciona?",
    en: "How does it work?",
